...
$select="select * from category  join subcat on category.Cat_id = subcat.Cat_id   join products on subcat.id = products.SubCat_id where stat='2'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Rejected Products <a href="addpr.php" ><button type="button" style="margin-left: 30px" class="btn  btn-primary">ADD PRODUCT</button></a></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../admin/homepage.php">Home</a></li>
              <li class="breadcrumb-item active">View Rejected Products</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover" style="box-sizing:border-box">
                  ...
                  <tr>
                    ...
                    <td>
		           <button type="button" class="btn  btn-danger"><a  style="color:white" onclick="approve(<?php echo $row['id'] ?>)" >APPROVE</a></button></td>
